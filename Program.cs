...
namespace PrivateMultipleObjects
{
    ...
    class ThingsToSell
    {
        ...
        private string _ConditionOfItem;
        private int _PriceOfItem;
        ...
        public virtual void addChange()
        {
            ...
            setNameOfItem(Console.ReadLine());
            Console.Write("Condition of Item for Sale=");
            setConditionOfItem(Console.ReadLine());
            Console.Write("Price of Item for Sale=");
            setPriceOfItem(int.Parse(Console.ReadLine()));
        }
        public virtual void print()
        {
            Console.WriteLine();
            Console.WriteLine($"ID: {getId()}");
            Console.WriteLine($"Name of Item for Sale: {getNameOfItem()}");
            Console.WriteLine($"Condition of Item for Sale: {getConditionOfItem()}");
            Console.WriteLine($"Price of Item for Sale: ${getPriceOfItem()}");
        }
